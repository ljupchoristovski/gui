...
//   const handleTypeChange = (event, n) => {
...
//                     <div>
//                       <span>{el}:</span>
//                       {el !== "type" && <span>{selectedDiagramNode[el]}</span>}
//                       {el === "type" && (
...
diagram.addDiagramListener("ObjectSingleClicked", function(e) {
  diagram.model.commit(function(m) {
    var data = m.nodeDataArray[0]; // get the first link data
    m.set(data, "color", "black");
    console.log(data);
  });
});
